...
- Deterministic file-based store (`state.json`, immutable package folders, active pointers) plus in-memory cycle/rollout evaluation state with persisted diagnostics (004-phase4-operational-enhancements)
