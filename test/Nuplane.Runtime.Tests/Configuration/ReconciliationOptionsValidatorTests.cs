...
public sealed class ReconciliationOptionsValidatorTests
{
    ...
    {
        var result = _sut.Validate(null, new ReconciliationOptions { PollInterval = TimeSpan.Zero });
    ...
    {
        var result = _sut.Validate(null, new ReconciliationOptions { MaxRetryAttempts = -1 });
    ...
    {
        var result = _sut.Validate(null, new ReconciliationOptions
        {
